...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CIranbitAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CIranbitAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CIranbitAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CIranbitAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CIranbitAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CIranbitAddress(arr[0].get_str()).Get() == demoAddress.Get());
