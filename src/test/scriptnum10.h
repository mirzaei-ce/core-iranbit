...
#ifndef IRANBIT_TEST_SCRIPTNUM10_H
#define IRANBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Iranbit Core 0.10.0, for cross-comparison.
 */
public:
