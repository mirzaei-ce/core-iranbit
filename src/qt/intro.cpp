...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/iranbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Iranbit Core"),
     ...
     * override -datadir in the iranbit.conf file in the default data directory
     * (to be consistent with iranbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
