...
#ifndef IRANBIT_QT_IRANBITUNITS_H
#define IRANBIT_QT_IRANBITUNITS_H
...
/** Iranbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class IranbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit IranbitUnits(QObject *parent);

    /** Iranbit units.
      @note Source: https://en.iranbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        IBT,
...
typedef IranbitUnits::Unit IranbitUnit;

#endif // IRANBIT_QT_IRANBITUNITS_H
