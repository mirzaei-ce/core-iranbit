...
#if defined(NDEBUG)
# error "Iranbit cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Iranbit Signed Message:\n";
                              ...
                              std::vector<uint256>& vHashTxnToUncache)
{
...

    {
        ...
        {
            LogPrint("mempool", "replacing tx %s with %s for %s IBT additional fees, %d delta bytes\n",
