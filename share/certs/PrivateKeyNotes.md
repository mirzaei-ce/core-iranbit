...
unlocked to sign the Iranbit-Qt.app bundle.
...
allowing somebody to distribute a Iranbit-Qt.app or iranbit-qt-setup.exe with a valid
...
that the iranbit-qt.exe file inside the installer had not been tampered with.
