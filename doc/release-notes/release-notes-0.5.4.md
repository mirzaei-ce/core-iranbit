Iranbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/iranbit/files/Iranbit/iranbit-0.5.4/
...
http://gitorious.org/iranbit/iranbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Iranbit-Qt notifications under Growl 1.3.
Increase required age of Iranbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxIranbit properly when installing Iranbit-Qt over it. (Windows)
