Iranbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/iranbit/files/Iranbit/iranbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Iranbit
...
New/changed settings (command-line or iranbit.conf file)
--------------------------------------------------------
