Iranbit Core version 0.9.4 is now available from:

  https://iranbit.org/bin/0.9.4/
...
this update is incompatible with the Iranbit system and could lead to consensus
forks.

Iranbit Core released binaries from https://iranbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~iranbit/+archive/ubuntu/iranbit
- A third-party or self-compiled Iranbit Core

upgrade to Iranbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
