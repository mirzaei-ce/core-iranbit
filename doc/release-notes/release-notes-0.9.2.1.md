Iranbit Core version 0.9.2.1 is now available from:

  https://iranbit.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 IBT to 0.01 IBT
...
- Fix "Start iranbit on system login"
