...
This document provides guidelines for internationalization of the Iranbit Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `iranbit_en.ts` remains unchanged.
